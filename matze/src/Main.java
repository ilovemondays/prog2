...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("  Bälle       : " + h.getBaelle());
        System.out.println("  Mannsch.gr. : " + h.mannschaftsGroesse());
        ...
        System.out.println("  Bälle       : " + j.getBaelle());
        System.out.println("  Lernen      : " + j.lernRegel());
